    ...
    <div class="page-holder">
        <header class="header bg-white">
            <div class="container px-0 px-lg-3">
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span class="font-weight-bold text-uppercase text-dark">U-Rental</span></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/rents">Rent</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <?php if (session()->get('role_id') === 'R0002') : ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fas fa-dolly-flatbed mr-1 text-gray"></i>Cart<small class="text-gray">(2)</small></a>
                                </li>
                            <?php endif; ?>
